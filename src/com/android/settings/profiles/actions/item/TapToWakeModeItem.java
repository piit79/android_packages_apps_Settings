...
public class TapToWakeModeItem implements Item {
    Profile mProfile;

    public TapToWakeModeItem(Profile profile) {
       mProfile = profile;
    }
    ...
    public View getView(LayoutInflater inflater, View convertView, ViewGroup parent) {
        ...
        text.setText(R.string.tap_to_wake);
    ...
    public static int getSummaryString(Profile profile) {
        switch (profile.getTapToWakeMode()) {
            case Profile.TapToWakeMode.DEFAULT:
                return R.string.profile_action_none; //"leave unchanged"
            case Profile.TapToWakeMode.ENABLE:
                return R.string.profile_action_enable;
            case Profile.TapToWakeMode.DISABLE:
